 ...
 * - 웹뷰
 */
public class SuspensionCompleteActivity extends BaseActivity {
    private static final String TAG = SuspensionCompleteActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTopTitle.setText(R.string.title_suspension_complete);
        ...
        mWebView.loadUrl(webUrl_suspension_complete);
        showProgressDialog();
    }
