 ...
 * - 웹뷰
 */
public class TerminationInfoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTopTitle.setText(R.string.title_termination_info);
        ...
        btnConfirm.setText(R.string.title_termination);
        ...
        mWebView.loadUrl(webUrl_termination_info);
        ...
        switch (v.getId()) {
            case R.id.btnConfirm:
                ...
                if (isShfgicLogin) {
                    ...
                    intent.putExtra(INTENT_KEY_MODE_TYPE, INTENT_VALUE_MODE_TERMINATION);
                    startActivity(intent);
                    finish();

                } else {
                    showAlertDialog(null, getString(R.string.alert_termination_login), getString(R.string.confirm), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(TerminationInfoActivity.this, IntergratedCertificationActivity.class);
                            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                            intent.putExtra(INTENT_KEY_MODE_TYPE, INTENT_VALUE_MODE_TERMINATION);
                            startActivity(intent);
                            finish();
